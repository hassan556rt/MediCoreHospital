...
public sealed class AuthenticationService : IAuthenticationService
{
    ...
    public async Task<LoginResult> LoginAsync(LoginRequest request, CancellationToken cancellationToken = default)
    {
        ...
        {
            return new LoginResult { Success = false, Message = "يرجى إدخال اسم المستخدم وكلمة المرور." };
        }
        ...
        var passwordVerified = BCrypt.Net.BCrypt.Verify(request.Password, storedHash);
        if (!passwordVerified)
        {
